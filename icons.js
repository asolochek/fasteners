...
const MISC = {
  ...
  gpib:        `<rect x="4" y="30" width="92" height="40" rx="20" fill="none" stroke="${K}" stroke-width="${SW}"/><rect x="16" y="41" width="68" height="18" rx="8" fill="none" stroke="${K}" stroke-width="3.5"/>${[26, 34, 42, 50, 58, 66, 74].map(x => `<line x1="${x}" y1="45" x2="${x}" y2="55" stroke="${K}" stroke-width="2.5"/>`).join('')}`,
