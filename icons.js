...
const LABELS = { flat: 'Flat', pan: 'Pan', socket: 'Socket cap', button: 'Button', hex: 'Hex', nylon: 'Nylon', setscrew: 'Set screw', shoulder: 'Shoulder', wood: 'Wood', sheetmetal: 'Sheet metal',
  nut: 'Nut', thin: 'Thin nut', lock: 'Lock nut', wing: 'Wing nut', washer: 'Washer', fender: 'Fender', thinw: 'Thin washer', nylonw: 'Plastic washer', split: 'Split lock', toothed: 'Toothed lock' };
